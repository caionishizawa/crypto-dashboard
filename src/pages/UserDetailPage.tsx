...
export const UserDetailPage: React.FC<UserDetailPageProps> = ({
	...
	// Defaults to keep UI consistent even when cliente is missing
			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="flex items-center justify-between mb-8">
					<div className="flex items-center space-x-4">
						...
						<div>
							<h1 className="text-3xl font-bold">Detalhes do Usuario</h1>
							<p className="text-gray-400">Visualizando informacoes completas</p>
						</div>
					</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						...
						<div className="space-y-4">
							<div className="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-lg">
								...
								<div>
									...
									<p className="font-semibold text-green-400">Usuario Aprovado</p>
								</div>
							</div>
					...
					{/* Card de Informacoes Tecnicas */}
					<div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
						<h3 className="text-xl font-semibold mb-4">Informacoes Tecnicas</h3>
						
						<div className="space-y-4">
							<div className="p-3 bg-gray-800/50 rounded-lg">
								<p className="text-sm text-gray-400">ID do Usuario</p>
								<p className="font-mono text-sm text-purple-400 break-all">{usuario.id}</p>
							</div>

							<div className="p-3 bg-gray-800/50 rounded-lg">
								<p className="text-sm text-gray-400">Data de Criacao</p>
							...
							<div className="p-3 bg-gray-800/50 rounded-lg">
								<p className="text-sm text-gray-400">Permissoes</p>
				...
				{/* Secao de Estatisticas */}
				<div className="mt-8 bg-gray-900 rounded-xl p-6 border border-gray-800">
					<h3 className="text-xl font-semibold mb-4">Estatisticas</h3>
				...
				{/* Secao de Informacoes Financeiras - sempre visivel */}
				<div className="mt-8 bg-gray-900 rounded-xl p-6 border border-gray-800">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<div className="bg-gray-800/50 rounded-lg p-4">
							...
							<div className="space-y-3">
								<div className="flex justify-between items-center">
									<span className="text-gray-400 text-sm">Data de Inicio</span>
									<span className="font-semibold">
								...
								{tipoPerfil === 'bitcoin' && (
									<>
										...
										<div className="flex justify-between items-center">
											<span className="text-gray-400 text-sm">Preco Medio</span>
											<span className="font-semibold">
								...
								{tipoPerfil === 'conservador' && (
									<>
										...
										<div className="flex justify-between items-center">
											<span className="text-gray-400 text-sm">APY Medio</span>
				...
				{/* Secao de Acoes */}
				<div className="mt-8 bg-gray-900 rounded-xl p-6 border border-gray-800">
					<h3 className="text-xl font-semibold mb-4">Acoes Disponiveis</h3>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
						<button className="p-4 bg-blue-600/20 border border-blue-600/30 rounded-lg hover:bg-blue-600/30 transition-colors">
							<div className="flex items-center space-x-3">
								...
								<div className="text-left">
									<p className="font-semibold">Gerenciar Permissoes</p>
									<p className="text-sm text-gray-400">Alterar nivel de acesso</p>
								</div>
							</div>
						</button>
						...
						<button className="p-4 bg-purple-600/20 border border-purple-600/30 rounded-lg hover:bg-purple-600/30 transition-colors">
							<div className="flex items-center space-x-3">
								<Calendar className="w-5 h-5 text-purple-400" />
								<div className="text-left">
									<p className="font-semibold">Ver Historico</p>
